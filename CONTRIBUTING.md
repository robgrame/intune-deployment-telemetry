...
2. Keep changes focused and free of tenant-specific data.
...
Never commit secrets, private keys, certificates, workspace keys, tenant IDs,
device data, or generated `local.settings.json` files.
